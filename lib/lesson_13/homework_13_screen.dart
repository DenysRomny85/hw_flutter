  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        if (redContainerWidth >= screenWidth) {
          return Container(
            color: Colors.red,
            height: 100,
...
// Відповідь: ConstrainedBox не застосовуються, тому що SizedBox блокує
...
/// Відповідь: OverflowBox дозволяє зеленому контейнеру виходити
/// за межі свого SizedBox
/// у Column — порядок зверху вниз, тому накладається на червоний а не на синій
...
// Відповідь: контейнер отримує висоту 100 від батьківського SizedBox
...
// Відповідь: LimitedBox працює тільки при unbounded constraints,
// а Scaffold передає розміри єкрану
